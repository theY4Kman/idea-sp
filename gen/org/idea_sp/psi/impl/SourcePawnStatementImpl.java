...
public class SourcePawnStatementImpl extends ASTWrapperPsiElement implements SourcePawnStatement {
  ...
  @Override
  @Nullable
  public SourcePawnBlockStatement getBlockStatement() {
    return findChildByClass(SourcePawnBlockStatement.class);
  }

  @Override
  @Nullable
  public SourcePawnSingleStatement getSingleStatement() {
    return findChildByClass(SourcePawnSingleStatement.class);
  }
